...
Students will be able to identify major healthcare career families, compare their education requirements and typical earnings, and map a realistic pathway for themselves.
...
- Pathway map: chart three different routes from high-school graduation to a specific role (RN, PA, biomedical scientist) showing years, costs, and credentials at each step
- Role profile: pick one career and produce a one-page summary — duties, education, salary, outlook, licensure, one credential that opens the door
- Short answer: explain the difference between a certificate, a license, and a degree, and give an example of each in healthcare
