...
Students will be able to name the eleven major organ systems, state each system's primary function, and give one common disorder associated with each.
...
- Matching grid: 11 systems × function × disorder — fill blanks from a word bank
- Scenario analysis: given a patient symptom list, identify which systems are likely involved and which might be failing
- Short essay: pick one disorder and explain which two systems are most directly involved and how
