    ...
    <subcluster>/
      crosswalks/
        <state>/
          ...
          coverage-report.md      # TEKS covered per course template
          sme-review.md           # automated SME-style review findings
```
...
| column | description |
|---|---|
| atom_id | references library/<cluster>/<subcluster>/atoms/<atom>.md |
